package org.arisgames.editor.components
{
	...
	public class GameEditorMediaPickerCustomEditorView extends VBox
	{		
		 ...
		 * Constructor
		 */
		public function GameEditorMediaPickerCustomEditorView()
		{
			super();
		...
		{
			trace("In GameEditorMediaPickerCustomEditorView's handleInit");
