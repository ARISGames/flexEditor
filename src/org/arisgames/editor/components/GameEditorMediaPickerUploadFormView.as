package org.arisgames.editor.components
{
	...
	public class GameEditorMediaPickerUploadFormView extends Panel
	{
		 ...
		 * Constructor
		 */
		public function GameEditorMediaPickerUploadFormView()
		{
			super();
		...
		{		
			trace("GameEditorMediaPickerUploader: handleCancelButton called...");
		...
		{
			trace("GameEditorMediaPickerUploadFormView: handleUploadAndSaveFileSuccess()");
			if (obj.result.returnCode != 0)
			{
				trace("GameEditorMediaPickerUploadFormView: Bad saving of uploaded media attempt... let's see what happened.  Error = '" + obj.result.returnCodeDescription + "'");
				var msg:String = obj.result.returnCodeDescription;
				Alert.show("Error Was: " + msg, "Error While Saving Uploaded Media");
			}
			else
			{
				trace("GameEditorEditorMediaPickerUploadFormView: Upload was legit, call the delegate with the new media");			
